...
Suporta bancos de dados (SQL Server, PostgreSQL, Oracle) e arquivos (CSV, Excel, Parquet).
...
def get_loader(data_source_type: str, file_path: str = None, read_params: dict = None):
    ...
    Args:
        data_source_type: Tipo da fonte de dados ('SQL_SERVER', 'POSTGRES', 'ORACLE', 'FILE', etc.)
    ...
    if data_source_type in ("ORACLE", "ORCL"):
        return OracleLoader()
